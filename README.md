#  Quantum Artificial Intelligence with Qiskit (1.1.1)
...
Check this repository for the newest port of qiskit version which is now version 1.1.1. Last correction, the file 10_8-Puzzle.ipynb. 
